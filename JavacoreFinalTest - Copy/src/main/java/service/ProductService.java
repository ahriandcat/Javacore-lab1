...
public class ProductService {
    ...
    public static void searchByPrice(){
        Collections.sort(getAllProducts(), new Comparator<Product>() {
            @Override
        ...
        while (true){
            ...
            switch (choose){
                case 1 -> {
                    showProductListByPrice(getAllProducts(),4000000,10000000);
                    CartService.addToCart(Controller.currentUser);
                }
                case 2 -> {
                    showProductListByPrice(getAllProducts(),10000000,20000000);
                    CartService.addToCart(Controller.currentUser);
                }
                case 3 -> {
                    showProductListByPrice(getAllProducts(),20000000,40000000);
                    CartService.addToCart(Controller.currentUser);
                }
                case 4 -> {
                    showProductListByPrice(getAllProducts(),40000000,70000000);
                    CartService.addToCart(Controller.currentUser);
                }
                case 5 -> {
                    showProductListByPrice(getAllProducts(),70000000,1000000000);
                    CartService.addToCart(Controller.currentUser);
                }
                case 0 -> {
                    return;
    ...
    public static void searchByCategory(){
        while (true){
            ...
            switch (choose){
                case 1 ->{
                    showProductListByType(getAllProducts(),Type.CPU);
                    CartService.addToCart(Controller.currentUser);
                }
                case 2 -> {
                    showProductListByType(getAllProducts(),Type.GPU);
                    CartService.addToCart(Controller.currentUser);
                }
                case 3 -> {
                    showProductListByType(getAllProducts(),Type.Mainboard);
                    CartService.addToCart(Controller.currentUser);
                }
                case 4 -> {
                    showProductListByType(getAllProducts(),Type.PSU);
                    CartService.addToCart(Controller.currentUser);
                }
                case 5 -> {
                    showProductListByType(getAllProducts(),Type.Ram);
                    CartService.addToCart(Controller.currentUser);
                }
                case 6 -> {
                    showProductListByType(getAllProducts(),Type.SSD);
                    CartService.addToCart(Controller.currentUser);
                }
                case 0 -> {
                    return;
